(function() {
        ...
        oa.prototype.j = function() {
            ...
            -1 < a && (w.splice(a, 1),
                this.c ? this.context.set(this.P, this.f) : this.context[this.P] = this.f)
        }
        ;
        function pa(a, b) {
        ...
        function xa(a, b) {
            ...
            if (a.a.indexFilename) {
                var e = d.split("/");
                a.a.indexFilename == e[e.length - 1] && (e[e.length - 1] = "",
                    d = e.join("/"))
            }
            ...
            return "function" == typeof a.a.urlFieldsFilter ? (b = a.a.urlFieldsFilter(d, u),
                c = {
                    page: b.page,
                    location: b.location
                },
        ...
        g.observeElements = function(a) {
            ...
            this.b || (this.b = new MutationObserver(this.M),
            ...
            for (var b = [], c = 0, d; d = a[c]; c++)
                for (var e = 0, h; h = this.items[e]; e++) {
                    ...
                    if (f = d.target.id === h.id)
                        (f = h.threshold) ? f = d.intersectionRatio >= f : (f = d.intersectionRect,
        ...
        function S(a, b, c) {
            ...
            O[a] || (O[a] = new R(a,c),
            P || (window.addEventListener("storage", Da),
                P = !0));
            return O[a]
        }
        function Ea() {
        ...
        R.prototype.j = function() {
            delete O[this.b];
            Object.keys(O).length || (window.removeEventListener("storage", Da),
                P = !1)
        }
        ;
        function Da(a) {
        ...
        U.prototype.isExpired = function(a) {
            ...
            return b && (a = new Date,
                b = new Date(b),
            a - b > 6E4 * this.timeout || this.c && this.c.format(a) != this.c.format(b)) ? !0 : !1
        }
        ;
        ...
        W.prototype.g = function() {
            var a = document.documentElement
                ...
                , b = V(this.m);
            b != this.a.get().sessionId && (Ga(this.a),
                this.a.set({
                    sessionId: b
                }));
            if (this.m.isExpired(this.a.get().sessionId))
                Ga(this.a);
            else if (b = this.a.get()[this.c] || 0,
            a > b && (100 != a && 100 != b || window.removeEventListener("scroll", this.g),
                b = a - b,
            100 == a || b >= this.b.increaseThreshold)) {
                var c = {};
                this.a.set((c[this.c] = a,
                    c.sessionId = V(this.m),
                    c));
                a = {
                    transport: "beacon",
        ...
        function Ma(a, b) {
            ...
            D(this.a.definitions) && (b = this.a.definitions,
        ...
        function Qa(a, b) {
            b.items.forEach(function(c) {
                ...
                var d = ta(function() {
                    ...
                    c !== d && (a.b.set("dimension" + b.dimensionIndex, c),
                        c = {
                            transport: "beacon",
        ...
        X.prototype.f = function(a, b) {
            ...
            if (this.a.shouldTrackOutboundForm(b, u)) {
                navigator.sendBeacon || (a.preventDefault(),
        ...
        Y.prototype.f = function(a, b) {
            ...
            if (this.a.shouldTrackOutboundLink(b, u)) {
                ...
                if (navigator.sendBeacon || "click" != a.type || "_blank" == b.target || a.metaKey || a.ctrlKey || a.shiftKey || a.altKey || 1 < a.which)
                    this.c.send("event", f);
                else {
                    var v = function() {
        ...
        g.s = function() {
            ...
            if ("visible" == document.visibilityState || "hidden" == document.visibilityState) {
                ...
                "visible" == document.visibilityState && this.a.sendInitialPageview && !this.o && (Ta(this),
                    this.o = !0);
                "hidden" == document.visibilityState && this.m && clearTimeout(this.m);
                this.f.isExpired(b.sessionId) ? (Ga(this.c),
                "hidden" == this.g && "visible" == document.visibilityState && (clearTimeout(this.m),
                    this.m = setTimeout(function() {
                        a.c.set(c);
                        Ta(a, {
                            hitTime: c.time
                        })
                    }, this.a.visibleThreshold))) : (b.pageId == Z && "visible" == b.state && Va(this, b),
                    this.c.set(c));
                this.g = document.visibilityState
            }
        }
        ...
        function Ua(a) {
            var b = a.c.get();
            "visible" == a.g && "hidden" == b.state && b.pageId != Z && (b.state = "visible",
                b.pageId = Z,
                a.c.set(b));
            return b
        }
        function Va(a, b, c) {
            ...
            var d = {
                ...
                , d = (d ? d : {}).hitTime;
            (b = b.time ? (d || +new Date) - b.time : 0) && b >= a.a.visibleThreshold && (b = Math.round(b / 1E3),
                d = {
                    transport: "beacon",
                    nonInteraction: !0,
        ...
        function Za(a, b) {
            setTimeout(function() {
                ...
                c != d && a.a.shouldTrackUrlChange.call(a, d, c) && (a.c = d,
                    a.b.set({
                        page: d,
